...
Для автоматической настройки сцены:
1. Откройте Unity Editor
2. Перейдите: **VR Ferma → Setup Scene**
3. Нажмите кнопки в порядке: Create All Managers → Setup Tags and Layers → Create Basic UI → Create Ground → Create Water Source
